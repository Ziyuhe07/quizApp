...
//The additional function is used to avoid trash between choosing coordinates features and question & answers features
...
function startDataUpload() { //the variables here are local, which are name, mobile ID, question, and answer chosen by users
	...
	//alert(name);
	//alert(name + " "+ mobileId); //separate alerts 

	var postString = "name="+name +"&mobileId="+mobileId;
